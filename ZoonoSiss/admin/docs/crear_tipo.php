...
$con=new conexion();
$sql="select * from tipo_mascota where nombre";
...
<main class="app-content">
    <div class="app-title">
        <div>
            <h1><i class="fa fa-edit"></i>Tipo Mascota</h1>
            <p>Registro Tipo Mascota</p>
        </div>
        <ul class="app-breadcrumb breadcrumb">
            <li class="breadcrumb-item"><i class="fa fa-home fa-lg"></i></li>
            <li class="breadcrumb-item">Tipo Mascota</li>
            <li class="breadcrumb-item"><a href="#"> Registro Tipo Mascota</a></li>
        </ul>
    </div>
    <div class="container">
            ...
            <div class="col-md-20">
                <div class="card">
                     <div class="card-header">
                        <center><h3>Nuevo Tipo Mascota </h3></center>
                    </div>
                    <div class="card-body">
                        <form name="f1" action="../../enrutador/enr_tipo.php" method="post" autocomplete="off" required>
