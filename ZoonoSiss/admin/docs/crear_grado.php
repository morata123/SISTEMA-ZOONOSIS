...
$con=new conexion();
$sql="select * from grado_peligro where nombre";
...
<main class="app-content">
    <div class="app-title">
        <div>
            <h1><i class="fa fa-edit"></i>Grado peligro Mascota</h1>
            <p>Registro Grado peligro</p>
        </div>
        <ul class="app-breadcrumb breadcrumb">
            <li class="breadcrumb-item"><i class="fa fa-home fa-lg"></i></li>
            <li class="breadcrumb-item">Grado peligro</li>
            <li class="breadcrumb-item"><a href="#"> Registro Grado peligro</a></li>
        </ul>
    </div>
    <div class="container">
            ...
            <div class="col-md-20">
                <div class="card">
                     <div class="card-header">
                        <center><h3>Nuevo Grado peligro </h3></center>
                    </div>
                    <div class="card-body">
                        <form name="f1" action="../../enrutador/enr_grado.php" method="post" autocomplete="off" required>
